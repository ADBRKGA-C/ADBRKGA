...
void ConfigParameter_ADRKGA() {
    Parameter_ADRKGA.NumOfChormPerPop = Tasks.size()*2;                                   //set the subpopulation size
    if (Parameter_ADRKGA.NumOfChormPerPop % 2 == 1) {
        ++Parameter_ADRKGA.NumOfChormPerPop;
    }
    Parameter_ADRKGA.ImmigrationRate = 0.1;
    Parameter_ADRKGA.alpha = 1.6;
    Parameter_ADRKGA.beta = 0.7;
    Parameter_ADRKGA.ImprovementRate= 0.08;
    Parameter_ADRKGA.BiasesRate= 0.85;
}
