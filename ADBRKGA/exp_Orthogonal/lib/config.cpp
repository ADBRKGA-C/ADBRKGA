...
void ConfigParameter_ADRKGA(Orthogonal orthogonal) {
    Parameter_ADRKGA.NumOfChormPerPop = Tasks.size()*orthogonal.PopSizeFac;                                   //set the subpopulation size
    if (Parameter_ADRKGA.NumOfChormPerPop % 2 == 1) {
        ++Parameter_ADRKGA.NumOfChormPerPop;
    }
    Parameter_ADRKGA.ImmigrationRate = orthogonal.ImmigrationRate;
    Parameter_ADRKGA.alpha = orthogonal.alpha;
    Parameter_ADRKGA.beta = orthogonal.beta;
    Parameter_ADRKGA.ImprovementRate= orthogonal.ImprovementRate;
    Parameter_ADRKGA.BiasesRate= orthogonal.BiasesRate;
}
