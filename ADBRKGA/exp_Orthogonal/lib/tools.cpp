...
void AdpDcd (chromosome&chrom ,double& CurTime,double& TotalTime) {
    ...
    vector<double > SP(3);
    SP[0] = pow(CurTime/TotalTime,Parameter_ADRKGA.alpha);
    SP[1] = Parameter_ADRKGA.beta * (1-pow(CurTime/TotalTime,Parameter_ADRKGA.alpha));
    SP[2] = (1-Parameter_ADRKGA.beta) * (1-pow(CurTime/TotalTime,Parameter_ADRKGA.alpha));
