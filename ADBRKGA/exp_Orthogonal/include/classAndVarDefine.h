...
class Paramet_ADRKGA {
public:
    int NumOfChormPerPop;     //the number of chromosomes in each subpopulation
    double alpha;
    double beta;
...
class Orthogonal{
public:
    double PopSizeFac ;     //the number of chromosomes in each subpopulation
    double alpha;
    double beta;
    double ImmigrationRate;
    double ImprovementRate;
...
extern Paramet_ADRKGA Parameter_ADRKGA;
